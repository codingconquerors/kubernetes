...
* The original package name 'com.cloud.spring.microservices.currencyexchange.currency-exchange-service' is invalid and this project uses 'com.cloud.spring.microservices.currencyexchange.currencyexchangeservice' instead.
