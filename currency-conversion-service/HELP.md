...
* The original package name 'com.cloud.spring.microservices.currencyconversion.currency-conversion-service' is invalid and this project uses 'com.cloud.spring.microservices.currencyconversion.currencyconversionservice' instead.
